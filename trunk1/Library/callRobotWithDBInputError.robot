...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <triggers/>
    <sub-robots>
      <sub-robot name="robotWithDBInputError"/>
    </sub-robots>
    <device-mappings/>
    <referenced-snippets/>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">status</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">Status</property>
        </property>
      </property>
    </object>
  </property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="2">
        <property name="name" class="String">Call robotWithDBInputError</property>
        <property name="stepAction" class="CallRobot2Step" serializationversion="0">
          <property name="robot2Name" class="String">robotWithDBInputError</property>
            ...
            <object class="kapow.robot.plugin.common.stepaction.rl2.DatabaseMappingBean">
              <property name="databaseName" class="kapow.robot.plugin.common.support.expression.stringexpr.DBNameValueStringExpression">
                <property name="value" class="kapow.util.db.DBName">
                  <property name="name" class="String">objectdb</property>
                </property>
              </property>
            </object>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="4">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          ...
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">status.Status</property>
          </property>
        </property>
